...
bot.start(async(ctx) => {
    ctx.replyWithHTML("<em>Welcome to <b>KatURLs Bot 🔗</b></em>\n\n<code>Send a Link to Shorten it with KatURLs.</code>\n\n/help for more info")
})
bot.command('help', (ctx) => ctx.replyWithHTML("💁‍♂️ Send a Link To Shorten it with KatURLs.\n\n<b><u>Example</u> 👇</b>\n\n<code>https://thetuhin.com</code>\n\n<code>If you have encountered any issue kindly report it at </code>@t_projects"));

bot.on('message', async(ctx) => {
    var message = ctx.message.text
    if (message == undefined) {
        ctx.replyWithHTML("<b>🙇‍♂️ Sorry,</b>\n\n<code>You are sending file. Send a valid Link to Shorten it with KatURLs.</code>\n\n/help for more info")
    } else if (!regex.test(message)) {
        ctx.replyWithHTML("<b>🙇‍♂️ Sorry,</b>\n\n<code>You are sending an invalid link kindly recheck and send again</code>\n\n/help for more info")
    } else {
        var config = {
            method: 'get',
            url: `https://katurls.com/api?api=${set.katurls_api_key}&url=${message}`
        };
